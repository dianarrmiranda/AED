...
{
  // word vai ser a chave
  // se find_hash_table_node(word) == NULL (a palavra não existe)
  //       cria/preenche umnovo nó
  //       insere o novo nó na tabela
  // else
  //     incrementa o campo value do nó encontrado
...
int main(int argc, char **argv)
{
  ...
  for (i = 1; i < argc; i++)
  {
    ...
    // init_hash_table(Tamanho a decidir) 10000 no mínimo
      init_hash_table(10000);
    //
